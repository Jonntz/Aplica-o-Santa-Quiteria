...
export const communitiesData: Community[] = [
  {
    ...
    address: 'Estrada do Lageado Velho, 1206',
    times: 'Domingo às 08h e 18h | Quinta às 20h',
  ...
  },
  {
    ...
    address: 'Rua Carlos Barbosa, 3',
    times: 'Domingo às 10h e 18h',
  ...
  },
  {
    id: 'santa-eulalia',
    name: 'Santa Eulália',
    address: 'Rua Joanienes Sobrinho, 9B',
    times: 'Sábado às 17h',
  ...
  },
  {
    id: 'santa-luzia',
    name: 'Santa Luzia',
    address: 'Rua Capitão Mor Francisco Falcão, 233',
    times: 'Domingo às 10h',
